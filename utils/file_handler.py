...
def load_instance(file_name):
    """
        This method reads an instance file and creates an Instance object,
        populating it with all the necessary information.
...
def create_instance_solution(instance, file_name, min_objf, optimal_cost, gap, end_cp, end_ls):
    """
        ...
        :param instance:  an nIstance object representing a CVRPB instance
        :param file_name: a string, the name of the instance file
    ...
    # Creates new file (overwrite if it exists)
    fp = open("data/Solutions/" + file_name + "_solution.txt", "w+")

    # file print of problem details
